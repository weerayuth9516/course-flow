    ...
    <div className="container font-inter mx-auto">
      ...
      <div className="bg-[url('src/assets/ourCourses/image_background.png')] bg-right bg-no-repeat">
        <div className="search-box mb-2 flex flex-col items-center mt-20 h-[230px]">
          ...
          <div className="flex space-x-4 mt-12"><button className="text-gray-700 focus:text-black focus:border-b focus:border-b-1 focus: border-black pb-2">All Course</button><button className="text-gray-700 focus:text-black focus:border-b focus:border-b-1 focus: border-black pb-2">Inprogress</button><button className="text-gray-700 focus:text-black focus:border-b focus:border-b-1 focus: border-black pb-2">Completed</button></div>
        </div>
      </div>
      <div className="user-image-and-course-container flex justify-center">
        <div className="user-box sticky top-0 w-[357px] h-[396px] rounded-lg shadow-lg mr-7 flex flex-col justify-center items-center">
         <div><img src="src/assets/myCourse/profile.png" alt="user-image" /></div>
