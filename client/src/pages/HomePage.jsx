...
export default function HomePage() {
  return <>
    ...
    <div className="flex pl-[15%] pr-[15%] mb-[100px] relative">
      ...
      <img className="object-cover h-auto w-[40%] rounded-md mr-[10%]"
        src={programmer}
        alt=""></img>
      <div className="flex flex-col">

        <div className="font-semibold text-header2">Learning experience has been</div>
        <div className="mb-[30px] font-semibold text-header2">enhanced with new technologies</div>
    ...
    <div className="flex pl-[15%] pr-[15%] gap-[50px] mb-[300px] relative">
      ...
      <div className="flex flex-col">
        ...
        <div className="font-semibold text-header2">Interaction between the tutor </div>
        <div className="mb-[30px] font-semibold text-header2">and the learners</div>
        <div className="flex mb-[20px]">
          <img className="mr-[15px] h-[30px] w-[30px] "
            src={commu}
            alt=""></img>
    ...
    <div className=" flex flex-col justify-center items-center">
      ...
      <div className="pl-[10%] pr-[10%] flex gap-[20px] mb-[200px]">
        <div className="flex flex-col justify-center items-center">
          <img className="w-[300px] h-[80%] object-cover rounded-md"
            src={instructor1}
            alt=""></img>
          <div>Jane Cooper</div>
    ...
    <div className="text-header2 font-semibold mb-[50px] flex items-center justify-center">Our Graduates</div>
    ...
    <Swiper navigation={true} modules={[Navigation]} className="mySwiper w-[80%] mb-[200px]">
