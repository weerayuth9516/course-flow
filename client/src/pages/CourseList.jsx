...
function CourseListPage() {
    ...
    const getCourseList = async (page, publicStatus, price, createdat, updatedat) => {
        try {
            ...
            <div className="w-[100%] flex flex-col">
                <div className="flex items-center text-center w-[100%] justify-between pt-6 pb-4 border-b-2">
                    ...
                    <div className="flex gap-3 items-center pr-[5%]">
                        <label for="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white"></label>
                        ...
                        <button className="bg-blue-500 hover:bg-blue-400 active:bg-blue-300 py-3.5 px-8 rounded-md text-white">+ Add Course</button>
                    </div>
                </div>
                    ...
                    <table className="table-auto absolute right-[5%] top-[5%] w-[90%]">
                        <thead className="bg-gray-300">
                            <tr>
                                ...
                                <th className="py-3 px-5 tracking-wide text-start">Course name</th>
                                <th className="py-3 px-5 tracking-wide text-start">Lesson</th>
                                <th className="py-3 px-5 tracking-wide text-start">Price</th>
                                <th className="py-3 px-5 tracking-wide text-start">Created date</th>
                                <th className="py-3 px-5 tracking-wide text-start">Updated date</th>
                            ...
                            {courseList.map((item, index) => {
                                return (
                                    ...
                                    <tr key={index} className="border-b-2">
                                        ...
                                        <td className="p-5">
                                            <img className="w-20 h-14 object-cover" src={item.course_cover_img}></img>
                                        </td>
